...
RUN SECRET_KEY='dummy-key-for-build' ID_ENCRYPTION_KEY='WPTnEteKbDAIR4cGw5PYHXeu_xgnafkmwmdn3HvXwnI=' python gestion_docentes/manage.py collectstatic --noinput
